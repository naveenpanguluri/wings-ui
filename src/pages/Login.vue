...
<div class="login">
  ...
  <div class="login-center">
    ...
    <div class="clearfix mtb-32">
      <button type="button" class="btn btn-cls pull-left" v-on:click.prevent="SignInUser">Sign in</button><span class="pull-right clr1 ptb-6"><a href="#" class="forgot clr2">Forgot password?</a></span>
    </div>
  </div>
