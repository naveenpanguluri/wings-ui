    ...
    <form @submit.prevent="formSubmit">
      <div class="row">
        <div class="col-md-12 col-lg-12">
          <h2 class="fw-100 text-center">Please fill the below form for Wings <small>'Arms To Serve'</small> Membership,</h2>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12 col-lg-12">
          <div class="user-img">
            <label for="file-upload" class="custom-file-upload">
             <div v-if="client.userprofileimage.length > 0">
      ...
      <div class="row mb-20">
        ...
        <div class="col-md-6 col-lg-6">
          <div class="form-group" :class="{ 'form-group--error': $v.client.phonenumber.$error }">
            <input type="number" class="form-control input-lg inpt-boxs" placeholder="phonenumber" @input="$v.client.phonenumber.$touch" v-model.number="$v.client.phonenumber.$model">
          </div>
      ...
      <div class="row mb-20">
        <div class="col-md-12 col-lg-12 text-right">
          <download-excel
          	...
          	:fields = "json_fields"
            type    = "csv"
          	name    = "WingsMembers.xls">Download Excel
          </download-excel>
...
export default {
  ...
  methods: {
    ...
    formSubmit: function() {
      ...
      if(!this.$v.$invalid){
        this.$Progress.start();
        this.$http.post('http://localhost:3001/api/clients', {
